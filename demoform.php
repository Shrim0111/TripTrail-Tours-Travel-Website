									...
									<div class="form-group  mt-3">
										...
										<div class="col-md-6 w-100">
											<div class="form-group mt-3">
												...
												<p id="pnumber_error" class="error"></p>
											...
											<div class="col-md-6 w-100">
												...
												<div class="form-group mt-3">
													...
													<input type="date" class="form-control" name="pdate" min="2024-11-06" placeholder="Select Arrival Date" required  id="pdate">
													<p id="pdate_error" class="error"></p>
												</div>
                                                <div class="col-md-6 w-100">
												<div class="form-group mt-3">
													<label>Leaving Date</label>
													<input type="date" class="form-control" name="ldate" min="2024-11-06" placeholder="Select Leaving Date" required  id="ldate">
