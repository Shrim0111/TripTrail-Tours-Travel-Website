...
if(isset($_REQUEST['signup'])) {
	...
	if(empty($fname) && empty($lname) && empty($contact) && empty($email)  && empty($pnumber) && empty($pname) && empty($pdate)&& empty($ldate)){
		...
		$sql  = "INSERT INTO demoform(id_fname,id_lname ,id_contact ,id_email, id_pnumber,id_pname, id_pdate,id_ldate) VALUES('$fname', '$lname','$contact' ,'$email',  '$pnumber','$pname' ,'$pdate','$ldate')";
